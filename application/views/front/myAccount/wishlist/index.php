                                    ...
                                    <div class="card b-0">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="shop_thumb position-relative">
                                                <a class="card-img-top d-block overflow-hidden" target="_blank" href="<?php echo base_url('products/' . ($wishlist_item['product_details']['slug'] ?? '') . '/details') ?>">
                                            ...
                                            <div class="text-left">
                                                <div class="text-center">
                                                    <h5 class="fw-bolder fs-md mb-0 lh-1 mb-1">
                                                        <a target="_blank" href="<?php echo base_url('products/' . ($wishlist_item['product_details']['slug'] ?? '') . '/details') ?>"><?php echo ($wishlist_item['product_details']['product_name'] ?? ''); ?></a>
                                                    </h5>
