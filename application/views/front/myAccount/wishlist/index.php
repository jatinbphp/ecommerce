            ...
            <?php foreach ($wishlists as $wishlist_item): ?>
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                    <div class="product_grid card b-0">
                        ...
                        <!-- Display product type badge if available -->
                        ...
                        <div class="card-footers b-0 pt-3 px-2 bg-white d-flex align-items-start justify-content-center">
                            <div class="text-left">
                                <div class="text-center">
                                    ...
                                    <div class="elis_rty"><span class="ft-bold fs-md text-dark"><?php echo '$'. number_format($wishlist_item['product_details']['price'], 2); ?></span></div>
                                </div>
                            </div>
                        </div>
                    </div>
