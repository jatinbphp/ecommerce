                ...
                <div class="row align-items-center rows-products grid">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-6">
                        <div class="product_grid card b-0">
                            <div class="card-body p-0">
                                <div class="shop_thumb position-relative">
                                    <a class="card-img-top d-block overflow-hidden" href="product-detail.html"><img class="card-img-top" src="images/13.jpg" alt="..."></a>
                                    <div class="edlio"><a href="#" data-toggle="modal" data-target="#quickview" class="product-hover-overlay bg-dark d-flex align-items-center justify-content-center text-white fs-sm ft-medium"><i class="fas fa-eye mr-1"></i>Quick View</a></div>
                                </div>
                            </div>
                            <div class="card-footer b-0 p-0 pt-2 bg-white">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-6">
                        <div class="product_grid card b-0">
                            ...
                            <div class="card-body p-0">
                                <div class="shop_thumb position-relative">
                                    <a class="card-img-top d-block overflow-hidden" href="product-detail.html"><img class="card-img-top" src="images/14.jpg" alt="..."></a>
                                    <div class="edlio"><a href="#" data-toggle="modal" data-target="#quickview" class="product-hover-overlay bg-dark d-flex align-items-center justify-content-center text-white fs-sm ft-medium"><i class="fas fa-eye mr-1"></i>Quick View</a></div>
                                </div>
                            </div>
                            <div class="card-footer b-0 p-0 pt-2 bg-white">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-6">
                        <div class="product_grid card b-0">
                            ...
                            <div class="card-body p-0">
                                <div class="shop_thumb position-relative">
                                    <a class="card-img-top d-block overflow-hidden" href="product-detail.html"><img class="card-img-top" src="images/6.jpg" alt="..."></a>
                                    <div class="edlio"><a href="#" data-toggle="modal" data-target="#quickview" class="product-hover-overlay bg-dark d-flex align-items-center justify-content-center text-white fs-sm ft-medium"><i class="fas fa-eye mr-1"></i>Quick View</a></div>
                                </div>
                            </div>
                            <div class="card-footer b-0 p-0 pt-2 bg-white">
