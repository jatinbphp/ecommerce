...
<div class="row mb-4">
    <div class="col-12 col-lg-12 col-xl-12 col-md-12">
        <div class="panel-group payaccordion" id="payments">
            <div class="accordion">
                <article class="panel panel-default border">
                    ...
                    <div id="delivey_method_c" class="panel-collapse collapse show" aria-labelledby="pay" data-parent="#payments">
                        <div class="panel-body">
                            ...
                            <?php endif; ?>    
                            <div class="row user-new-cart <?php echo (isset($i) && $i!=1) ? 'd-none' : '' ?>">
                                ...
                                <?php if($this->session->userdata('userId')): ?>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            <input id="saveForLater" class="checkbox-custom" name="save_for_later" type="checkbox">
                                            <label for="saveForLater" class="text-dark ft-medium checkbox-custom-label">Save Card Details</label>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            </div>
...
<script>
    $(document).ready(function(){
        $('.user-card').change(function(){
            if($(this).val() == '0'){
                $('.user-new-cart').removeClass('d-none');
            } else {
                $('.user-new-cart').addClass('d-none');
            }
        });
    });
