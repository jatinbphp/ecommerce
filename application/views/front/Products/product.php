<div class="product_grid card b-0">
    ...
    <div class="card-body p-0">
        <div class="shop_thumb position-relative">
            ...
            <a class="card-img-top d-block overflow-hidden" target="_blank" href="<?= base_url('products/' . $value['slug'] . '/details') ?>"><img class="card-img-top image-view" src="<?php echo base_url($image); ?>" alt="..."></a>
    ...
    <div class="card-footer b-0 p-0 pt-2 bg-white">
        ...
        <div class="text-left">
            <h5 class="fw-bolder fs-md mb-0 lh-1 mb-1"><a target="_blank" href="<?= base_url('products/' . $value['slug'] . '/details') ?>"><?= ucwords($value['product_name']) ?></a></h5>
